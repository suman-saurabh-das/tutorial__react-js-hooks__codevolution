...
function IntervalHookCounter() {
  ...
  useEffect(() => {
    ...
    // }, [count])  // When we are using the tick method directly updating the count

    // }, [])       // When we are using the tick method with prevCount

  }, [someProp])    // when we are using the doSomething() method
